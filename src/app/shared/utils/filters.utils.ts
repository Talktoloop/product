...
import { IFiltersData } from "@core/services/filters/model/filters-data.model";
...
export function prepareStoriesFilterData(
  ...
  filtersService.filtersData$.pipe(take(1), takeUntil(destroyed$)).subscribe((filtersData: IFiltersData) => {
    filtersConfig$.next(
      cloneDeep(openStoriesFiltersConfig).map((singleConfig) => {
        switch (singleConfig.internalName) {
          ...
          case StoriesFilters.CHANNEL_FILTER:
            return {
              ...singleConfig,
              data: { data: filtersData.channelFilter, titleKey: 'filtersV2.channel.label' } as CheckboxFilterData,
            };
          ...
          case StoriesFilters.LANGUAGE:
            return {
              ...singleConfig,
              data: { data: filtersData.languages, titleKey: 'filtersV2.preset.label' } as CheckboxFilterData
            };
          case StoriesFilters.ORGANISATION_RESPONSIVENESS:
            return {
              ...singleConfig,
              data: { data: filtersData.organisationResponsiveness, titleKey: 'filtersV2.organisationResponsiveness.label' } as CheckboxFilterData,
            };
          case StoriesFilters.COMMUNITY_RESPONSIVENESS:
            return {
              ...singleConfig,
