...
exports.WhatsAppMessengerController = void 0;
...
let WhatsAppMessengerController = class WhatsAppMessengerController {
    constructor(messengerService, storyService) {
        this.messengerService = messengerService;
        this.storyService = storyService;
    }
    async saveWhatsAppFlowRecord(data) {
        const conversation = this.messengerService.saveMessengerFlow(data, channel_constant_1.CHANNEL_CONSTANTS.WHATSAPP);
    ...
    async sendWhatsAppMessage(data) {
        ...
        const result = await this.messengerService.sendMessengerChatMessage(data, 'sendMessageToWhatsappChat', channel_constant_1.CHANNEL_CONSTANTS.WHATSAPP);
        return (0, class_transformer_1.plainToClass)(send_message_ro_1.SendMessageRO, result);
    }
    async saveWhatsAppMessage(data) {
        return this.messengerService.saveMessengerResponse(data, channel_constant_1.CHANNEL_CONSTANTS.WHATSAPP);
    }
    async checkWhatsAppAvailability(storyId) {
        return this.messengerService.checkMessengerAvailability(storyId, 'checkWhatsappConversationAvailability', channel_constant_1.CHANNEL_CONSTANTS.WHATSAPP);
    }
};
exports.WhatsAppMessengerController = WhatsAppMessengerController;
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'saveWhatsappStory' }),
...
], WhatsAppMessengerController.prototype, "saveWhatsAppFlowRecord", null);
__decorate([
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiResponse)({ status: 200, type: send_message_ro_1.SendMessageRO }),
    (0, swagger_1.ApiOperation)({ summary: 'Send WhatsApp Messenger Message' }),
    ...
    __metadata("design:returntype", Promise)
], WhatsAppMessengerController.prototype, "sendWhatsAppMessage", null);
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'saveWhatsappMessage' }),
    ...
    __metadata("design:returntype", Promise)
], WhatsAppMessengerController.prototype, "saveWhatsAppMessage", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], WhatsAppMessengerController.prototype, "checkWhatsAppAvailability", null);
exports.WhatsAppMessengerController = WhatsAppMessengerController = __decorate([
    (0, swagger_1.ApiTags)('WhatsApp'),
    (0, common_1.Controller)('messenger/whatsapp'),
    __metadata("design:paramtypes", [messenger_service_1.MessengerService,
        story_service_1.StoryService])
], WhatsAppMessengerController);
//# sourceMappingURL=whats-app.controller.js.map