...
export interface LexiconServiceFactory {
    findAll(): Promise<(OrganisationEntity | ThematicEntity | RejectReasonEntity | MaternityStatusEntity | DifficultyEntity)[]>;
    findByIdOrFail(id: number | string): Promise<OrganisationEntity | ThematicEntity | RejectReasonEntity | MaternityStatusEntity | DifficultyEntity>;
}
