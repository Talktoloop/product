...
export type CategoryToExport = {
    storyId: string;
    categoryId: string;
};
export type DifficultyToExport = {
    storyId: string;
    difficultyId: string;
};
export type OrganisationToExport = {
    storyId: string;
    organisationId: string;
};
export type ThematicAreaToExport = {
    storyId: string;
    thematicAreaId: number;
};
export type StoryRecipientToExport = {
    storyId: string;
    storyRecipientId: number;
    isMinority: boolean;
};
export type DataToExport = {
    ...
    recipients: (StoryRecipientEntity & {
        storyId: string;
    })[];
