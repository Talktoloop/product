...
export const populationTypeMapping = {
...
export const responsibilityCategoryMapping = {
  internal: 'Internal',
  external: 'External',
};

export const sensitivityCategoryMapping = {
  0: 'Non-sensitive',
  1: 'Sensitive',
};

export const criticalityCategoryMapping = {
...
export const feedbackCategoryMapping = {
...
export const resolutionCategoryMapping = {
