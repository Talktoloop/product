...
export class TelegramService {
    ...
    /**
     * Send Telegram Messenger Message
     * @returns SendMessageRO
     * @throws ApiError
     */
    public telegramMessengerControllerSendTelegramMessage({
        requestBody,
    }: {
        ...
        return this.httpRequest.request({
            method: 'POST',
            url: '/api/v1/messenger/telegram/message',
            body: requestBody,
     ...
     * @throws ApiError
     */
    public telegramMessengerControllerCheckTelegramConversationAvailability({
        storyId,
    }: {
        storyId: string,
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/api/v1/messenger/telegram/is-conversation-available/{storyId}',
            path: {
                'storyId': storyId,
            },
        });
