    ...
    extend: {
      colors: {
        ...
        dark: {
          ...
          primary: {
            DEFAULT: 'var(--color-loop-500)',
            foreground: 'var(--color-loop-300)',
            contrast: 'var(--color-dark-gray-300)',
            50: 'var(--color-loop-950)',
            100: 'var(--color-loop-900)',
            200: 'var(--color-loop-800)',
            300: 'var(--color-loop-700)',
            400: 'var(--color-loop-600)',
            500: 'var(--color-loop-500)',
            600: 'var(--color-loop-400)',
            700: 'var(--color-loop-300)',
            800: 'var(--color-loop-200)',
            900: 'var(--color-loop-100)',
            950: 'var(--color-loop-50)',
          },
